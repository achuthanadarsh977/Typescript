...
function Log(target, key, descriptor) {
    ...
    descriptor.value = function () {
        ...
        console.log("-> ".concat(String(key), " called with"), args);
        var result = original.apply(this, args);
        console.log("-> ".concat(String(key), " returned with result"), result);
        return result;
    };
    return descriptor; // ✅ return the modified descriptor
}
var access1 = function () {
    var _a;
    ...
    return _a = /** @class */ (function () {
            ...
            access1.prototype.add = function (a, b) {
                return a + b;
            };
            return access1;
        }()),
